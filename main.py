...
pen.hideturtle()
pen.goto(0, 260)
pen.write("{}                             {}".format(scoreA, scoreB), align="center", font=("Comic Sans MS", 24,
                                                                                            "normal"))
...
while True:
    ...
    if (ball.xcor() > 330) and (ball.xcor() < 340) and (ball.ycor() < paddleB.ycor() + 50) and (ball.ycor() >
                                                                                                paddleB.ycor() - 50):
        ball.setx(330)
        ball.dx *= -1

    if (ball.xcor() < -330) and (ball.xcor() > -340) and (ball.ycor() < paddleA.ycor() + 50) and (ball.ycor() >
                                                                                                  paddleA.ycor() - 50):
        ball.setx(-330)
        ball.dx *= -1
